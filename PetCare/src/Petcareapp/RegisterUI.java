...
public class RegisterUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Pet Care Application : Registration");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (username.isEmpty() || password.isEmpty() || role == null || Email.isEmpty() || phone.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please fill in all fields.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (dbHandler.registerUser(username, password, role, Email, phone)) {
        ...
        System.out.println(username + " " + password + " " + role + " " + Email + " " + phone);
